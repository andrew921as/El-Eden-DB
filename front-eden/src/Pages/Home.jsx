...
function Home() {
  ...
  // guardar el json del usuario en una variable
      ...
      >
        {esAdimin ? (
          ...
          >
            ...
            >
              ...
              <AccordionDetails>
                <MenuItem onClick={() => navigate("/Registro-Usuario")}>
                  <ChevronRightIcon fontSize="1.4rem" />
            ...
            >
              ...
              <AccordionDetails>
                ...
                <MenuItem onClick={() => navigate("/Buscar-Voluntario")}>
                  <ChevronRightIcon fontSize="1.5rem" />
                  Buscar voluntario
                </MenuItem>
              </AccordionDetails>
            ...
            <IconButton
              sx={{ gap: 2, borderRadius: 0, color: "#d84707" }}
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: { md: "1.4rem" } }}>
                Registrar Cliente
              </Typography>
            </Button>
            <Button
